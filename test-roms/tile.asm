...
.wait_vblank
    ...
    jr c, .wait_vblank  ; Loop as long as the carry flag is set
...
.copy_loop
    ...
    jr nz, .copy_loop   ; If B isn't zero, continue looping
...
.clear_loop
    ...
    jr nz, .clear_loop  ; If B and C are both zero, OR C will be zero, otherwise keep looping
