...
; 00 ff - 0000 0000 1111 1111
; pixel 0 => 10
; pixel 1 => 10
; ...
; pixel 7 => 10

; 00 80 - 0000 0000|1000 0000
; pixel 0 => 10
; pixel 1 => 00
; ...
; pixel 7 => 00

; second tile: 00 ff 00 80 00 80 00 80 00 80 00 80 00 80 00 80
; first  row:  00 ff => all pixels dark gray
; second row:  00 80 => first pixel dark gray and the rest white
Tiles:
